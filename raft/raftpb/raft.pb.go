...
import (
	fmt "fmt"
	fmt "go.etcd.io/fmt"
	_ "go.etcd.io/github.com/gogo/protobuf/gogoproto"
	proto "go.etcd.io/github.com/golang/protobuf/proto"
	io "go.etcd.io/io"
	math_bits "go.etcd.io/math/bits"
	math "math"
)
...
type Message struct {
	...
	Priority             uint64      `protobuf:"varint,13,opt,name=priority" json:"priority"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
var fileDescriptor_b042552c306ae59b = []byte{
	...
	,
}
...
func (m *SnapshotMetadata) MarshalTo(dAtA []byte) (int, error) {
	...
	n1, err1 := m.ConfState.MarshalTo(dAtA[i:])
	if err1 != nil {
		return 0, err1
	}
	i += n1
...
func (m *Message) MarshalTo(dAtA []byte) (int, error) {
	...
	n3, err3 := m.Snapshot.MarshalTo(dAtA[i:])
	if err3 != nil {
		return 0, err3
	}
	i += n3
