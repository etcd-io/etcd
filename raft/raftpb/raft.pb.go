...
type Message struct {
	...
	// The targets to send raft logs through the delegate
	BcastTargets []uint64 `protobuf:"varint,13,rep,name=bcastTargets" json:"bcastTargets,omitempty"`
	// The group id of the `from`
	GroupID uint64 `protobuf:"varint,14,opt,name=groupID" json:"groupID"`
	// Whether the message comes from a delegate actually
	Delegate         uint64 `protobuf:"varint,16,opt,name=delegate" json:"delegate"`
	XXX_unrecognized []byte `json:"-"`
}
...
func (m *Message) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.BcastTargets) > 0 {
		for _, num := range m.BcastTargets {
			dAtA[i] = 0x68
			i++
	...
	dAtA[i] = 0x1
	i++
	i = encodeVarintRaft(dAtA, i, uint64(m.Delegate))
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
	return i, nil
...
func (m *Message) Size() (n int) {
	...
	if len(m.BcastTargets) > 0 {
		for _, e := range m.BcastTargets {
			n += 1 + sovRaft(uint64(e))
		}
	}
	n += 1 + sovRaft(uint64(m.GroupID))
	n += 2 + sovRaft(uint64(m.Delegate))
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	return n
	...
	for iNdEx < l {
		...
		case 13:
			if wireType == 0 {
				...
				m.BcastTargets = append(m.BcastTargets, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field BcastTargets", wireType)
			}
		case 14:
			if wireType != 0 {
...
var fileDescriptorRaft = []byte{
	...
	,
}
