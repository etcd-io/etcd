...
import (
	...
	"github.com/cyralinc/etcd/etcdserver/api/etcdhttp"
	"github.com/cyralinc/etcd/etcdserver/api/rafthttp"
	"github.com/cyralinc/etcd/etcdserver/api/v2http"
	"github.com/cyralinc/etcd/etcdserver/api/v3client"
	"github.com/cyralinc/etcd/etcdserver/api/v3election"
	epb "github.com/cyralinc/etcd/etcdserver/api/v3election/v3electionpb"
	"github.com/cyralinc/etcd/etcdserver/api/v3lock"
	lockpb "github.com/cyralinc/etcd/etcdserver/api/v3lock/v3lockpb"
	"github.com/cyralinc/etcd/etcdserver/api/v3rpc"
