...
/*
	Package qospb is a generated protocol buffer package.
...
func (*Subject) Descriptor() ([]byte, []int) { return fileDescriptorQos, []int{0} }

type QoSRule struct {
	RuleName    string   `protobuf:"bytes,1,opt,name=rule_name,json=ruleName,proto3" json:"rule_name,omitempty"`
	RuleType    string   `protobuf:"bytes,2,opt,name=rule_type,json=ruleType,proto3" json:"rule_type,omitempty"`
	Subject     *Subject `protobuf:"bytes,3,opt,name=subject" json:"subject,omitempty"`
...
func (*QoSRule) Descriptor() ([]byte, []int) { return fileDescriptorQos, []int{1} }
...
func (m *QoSRule) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Subject != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintQos(dAtA, i, uint64(m.Subject.Size()))
