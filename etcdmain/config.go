...
func newConfig() *config {
	...
	fs.BoolVar(&cfg.ec.ExperimentalVersionDowngrade, "experimental-version-downgrade", cfg.ec.ExperimentalVersionDowngrade, "Enable to allow one single minor version downgrade automatically")
