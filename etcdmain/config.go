...
func newConfig() *config {
	...
	fs.Float64Var(&cfg.RandomizedElectionCoefficient, "randomized-election-coefficient", cfg.RandomizedElectionCoefficient, "A coefficient of randomized part of election timeout.")
