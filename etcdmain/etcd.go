...
import (
	...
	pkgioutil "go.etcd.io/etcd/v4/pkg/ioutil"
	"go.etcd.io/etcd/v4/pkg/osutil"
	"go.etcd.io/etcd/v4/pkg/transport"
	"go.etcd.io/etcd/v4/pkg/types"
	"go.etcd.io/etcd/v4/proxy/httpproxy"
...
var plog = capnslog.NewPackageLogger("go.etcd.io/etcd/v4", "etcdmain")
