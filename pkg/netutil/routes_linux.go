...
var errNoDefaultRoute = errors.New("could not find default route")
var errNoDefaultHost = errors.New("could not find default host")
var errNoDefaultInterface = errors.New("could not find default interface")
