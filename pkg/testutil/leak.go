...
running(leaking) after all tests.
	...
	import "go.etcd.io/etcd/v4/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "go.etcd.io/etcd/v4/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "go.etcd.io/etcd/v4/pkg/logutil.(*MergeLogger).outputLoop") ||
