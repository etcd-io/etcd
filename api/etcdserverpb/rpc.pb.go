...
type ShowProcessListRequest_Type int32

const (
	ShowProcessListRequest_OP     ShowProcessListRequest_Type = 0
	ShowProcessListRequest_STREAM ShowProcessListRequest_Type = 1
)

var ShowProcessListRequest_Type_name = map[int32]string{
	0: "OP",
	1: "STREAM",
}

var ShowProcessListRequest_Type_value = map[string]int32{
	"OP":     0,
	"STREAM": 1,
}

func (x ShowProcessListRequest_Type) String() string {
	return proto.EnumName(ShowProcessListRequest_Type_name, int32(x))
}

func (ShowProcessListRequest_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{52, 0}
}

type KillRequest_Type int32

const (
	KillRequest_OP     KillRequest_Type = 0
	KillRequest_STREAM KillRequest_Type = 1
)

var KillRequest_Type_name = map[int32]string{
	0: "OP",
	1: "STREAM",
}

var KillRequest_Type_value = map[string]int32{
	"OP":     0,
	"STREAM": 1,
}

func (x KillRequest_Type) String() string {
	return proto.EnumName(KillRequest_Type_name, int32(x))
}

func (KillRequest_Type) EnumDescriptor() ([]byte, []int) {
...
type ShowProcessListRequest struct {
	...
	Type                 ShowProcessListRequest_Type `protobuf:"varint,2,opt,name=type,proto3,enum=etcdserverpb.ShowProcessListRequest_Type" json:"type,omitempty"`
...
func (m *ShowProcessListRequest) GetCountOnly() bool {
	if m != nil {
		return m.CountOnly
	}
	return false
...
func (m *ShowProcessListRequest) GetType() ShowProcessListRequest_Type {
	if m != nil {
		return m.Type
	}
	return ShowProcessListRequest_OP
}

func (m *ShowProcessListRequest) GetId() int64 {
	if m != nil {
		return m.Id
	}
	return 0
...
type ShowProcessListResponse struct {
	Header               *ResponseHeader       `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
	Pls                  []*mvccpb.ProcessList `protobuf:"bytes,2,rep,name=pls,proto3" json:"pls,omitempty"`
...
func (m *ShowProcessListResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *ShowProcessListResponse) GetPls() []*mvccpb.ProcessList {
	if m != nil {
		return m.Pls
	}
	return nil
...
func (m *ShowProcessListResponse) GetCount() int64 {
	if m != nil {
		return m.Count
	}
	return 0
...
type KillRequest struct {
	Type                 KillRequest_Type `protobuf:"varint,1,opt,name=type,proto3,enum=etcdserverpb.KillRequest_Type" json:"type,omitempty"`
	Id                   int64            `protobuf:"varint,2,opt,name=id,proto3" json:"id,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
...
func (m *KillRequest) GetType() KillRequest_Type {
	if m != nil {
		return m.Type
	}
	return KillRequest_OP
}

func (m *KillRequest) GetId() int64 {
	if m != nil {
		return m.Id
	}
	return 0
...
func (m *KillResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("etcdserverpb.ShowProcessListRequest_Type", ShowProcessListRequest_Type_name, ShowProcessListRequest_Type_value)
	proto.RegisterEnum("etcdserverpb.KillRequest_Type", KillRequest_Type_name, KillRequest_Type_value)
	...
	proto.RegisterType((*ShowProcessListRequest)(nil), "etcdserverpb.ShowProcessListRequest")
	proto.RegisterType((*ShowProcessListResponse)(nil), "etcdserverpb.ShowProcessListResponse")
	proto.RegisterType((*KillRequest)(nil), "etcdserverpb.KillRequest")
	proto.RegisterType((*KillResponse)(nil), "etcdserverpb.KillResponse")
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	,
}
...
type MaintenanceClient interface {
	...
	// ShowProcessList gets the process list.
	ShowProcessList(ctx context.Context, in *ShowProcessListRequest, opts ...grpc.CallOption) (*ShowProcessListResponse, error)
	// Kill kills a connection from show processlist.
...
func (c *maintenanceClient) ShowProcessList(ctx context.Context, in *ShowProcessListRequest, opts ...grpc.CallOption) (*ShowProcessListResponse, error) {
	out := new(ShowProcessListResponse)
	err := c.cc.Invoke(ctx, "/etcdserverpb.Maintenance/ShowProcessList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *maintenanceClient) Kill(ctx context.Context, in *KillRequest, opts ...grpc.CallOption) (*KillResponse, error) {
	out := new(KillResponse)
	err := c.cc.Invoke(ctx, "/etcdserverpb.Maintenance/Kill", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MaintenanceServer interface {
	...
	// ShowProcessList gets the process list.
	ShowProcessList(context.Context, *ShowProcessListRequest) (*ShowProcessListResponse, error)
	// Kill kills a connection from show processlist.
...
func (*UnimplementedMaintenanceServer) ShowProcessList(ctx context.Context, req *ShowProcessListRequest) (*ShowProcessListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ShowProcessList not implemented")
}
func (*UnimplementedMaintenanceServer) Kill(ctx context.Context, req *KillRequest) (*KillResponse, error) {
...
func _Maintenance_ShowProcessList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShowProcessListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MaintenanceServer).ShowProcessList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/etcdserverpb.Maintenance/ShowProcessList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MaintenanceServer).ShowProcessList(ctx, req.(*ShowProcessListRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Maintenance_Kill_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(KillRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MaintenanceServer).Kill(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/etcdserverpb.Maintenance/Kill",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MaintenanceServer).Kill(ctx, req.(*KillRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Maintenance_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ShowProcessList",
			Handler:    _Maintenance_ShowProcessList_Handler,
		},
		{
			MethodName: "Kill",
			Handler:    _Maintenance_Kill_Handler,
		},
		{
			MethodName: "Hash",
...
func (m *ShowProcessListResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Pls) > 0 {
		for iNdEx := len(m.Pls) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Pls[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *KillResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *KillResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *KillResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *KillResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= ShowProcessListRequest_Type(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ShowProcessListResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Pls", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Pls = append(m.Pls, &mvccpb.ProcessList{})
			if err := m.Pls[len(m.Pls)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= KillRequest_Type(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *KillResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
