...
const (
	// MEMBER_ADDED indicates a new member was added to the cluster.
	MemberEventType_MEMBER_ADDED MemberEventType = 0
	// MEMBER_REMOVED indicates a member was removed from the cluster.
	MemberEventType_MEMBER_REMOVED MemberEventType = 1
	// MEMBER_UPDATED indicates a member's configuration was updated.
	MemberEventType_MEMBER_UPDATED MemberEventType = 2
	// MEMBER_PROMOTED indicates a learner member was promoted to voting member.
	MemberEventType_MEMBER_PROMOTED MemberEventType = 3
)
...
type MemberWatchRequest struct {
	// include_current_members, if set, sends the current member list as the first response
	// before streaming subsequent changes.
	IncludeCurrentMembers bool     `protobuf:"varint,1,opt,name=include_current_members,json=includeCurrentMembers,proto3" json:"include_current_members,omitempty"`
	XXX_NoUnkeyedLiteral  struct{} `json:"-"`
	XXX_unrecognized      []byte   `json:"-"`
	XXX_sizecache         int32    `json:"-"`
}

func (m *MemberWatchRequest) Reset()         { *m = MemberWatchRequest{} }
func (m *MemberWatchRequest) String() string { return proto.CompactTextString(m) }
func (*MemberWatchRequest) ProtoMessage()    {}
func (*MemberWatchRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{50}
}
func (m *MemberWatchRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MemberWatchRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MemberWatchRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MemberWatchRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MemberWatchRequest.Merge(m, src)
}
func (m *MemberWatchRequest) XXX_Size() int {
	return m.Size()
}
func (m *MemberWatchRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_MemberWatchRequest.DiscardUnknown(m)
}

var xxx_messageInfo_MemberWatchRequest proto.InternalMessageInfo

func (m *MemberWatchRequest) GetIncludeCurrentMembers() bool {
	if m != nil {
		return m.IncludeCurrentMembers
	}
	return false
}

type MemberWatchResponse struct {
	Header *ResponseHeader `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
	// events is a list of membership change events.
	Events []*MemberEvent `protobuf:"bytes,2,rep,name=events,proto3" json:"events,omitempty"`
	// members is the current list of all members in the cluster.
	// This is only populated in the first response when include_current_members is true.
	Members              []*Member `protobuf:"bytes,3,rep,name=members,proto3" json:"members,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
...
func (m *MemberWatchResponse) Reset()         { *m = MemberWatchResponse{} }
func (m *MemberWatchResponse) String() string { return proto.CompactTextString(m) }
func (*MemberWatchResponse) ProtoMessage()    {}
func (*MemberWatchResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{51}
}
func (m *MemberWatchResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MemberWatchResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MemberWatchResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MemberWatchResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MemberWatchResponse.Merge(m, src)
}
func (m *MemberWatchResponse) XXX_Size() int {
	return m.Size()
}
func (m *MemberWatchResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MemberWatchResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MemberWatchResponse proto.InternalMessageInfo

func (m *MemberWatchResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *MemberWatchResponse) GetEvents() []*MemberEvent {
	if m != nil {
		return m.Events
	}
	return nil
...
func (m *MemberWatchResponse) GetMembers() []*Member {
	if m != nil {
		return m.Members
	}
	return nil
...
type MemberEvent struct {
	// type is the kind of membership change event.
	Type MemberEventType `protobuf:"varint,1,opt,name=type,proto3,enum=etcdserverpb.MemberEventType" json:"type,omitempty"`
	// member is the member that was affected by the event.
	Member               *Member  `protobuf:"bytes,2,opt,name=member,proto3" json:"member,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *MemberEvent) GetType() MemberEventType {
	...
	return MemberEventType_MEMBER_ADDED
}
...
func init() {
	proto.RegisterEnum("etcdserverpb.MemberEventType", MemberEventType_name, MemberEventType_value)
	...
	proto.RegisterType((*MemberWatchRequest)(nil), "etcdserverpb.MemberWatchRequest")
	proto.RegisterType((*MemberWatchResponse)(nil), "etcdserverpb.MemberWatchResponse")
	proto.RegisterType((*MemberEvent)(nil), "etcdserverpb.MemberEvent")
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	,
}
...
type ClusterClient interface {
	...
	// It streams membership events (add, remove, update, promote) as they occur.
	// Supported since etcd 3.7.
	MemberWatch(ctx context.Context, in *MemberWatchRequest, opts ...grpc.CallOption) (Cluster_MemberWatchClient, error)
}
...
func (c *clusterClient) MemberWatch(ctx context.Context, in *MemberWatchRequest, opts ...grpc.CallOption) (Cluster_MemberWatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Cluster_serviceDesc.Streams[0], "/etcdserverpb.Cluster/MemberWatch", opts...)
	if err != nil {
		return nil, err
	}
	x := &clusterMemberWatchClient{stream}
...
type Cluster_MemberWatchClient interface {
	Recv() (*MemberWatchResponse, error)
	grpc.ClientStream
}

type clusterMemberWatchClient struct {
	grpc.ClientStream
}

func (x *clusterMemberWatchClient) Recv() (*MemberWatchResponse, error) {
	m := new(MemberWatchResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type ClusterServer interface {
	...
	// It streams membership events (add, remove, update, promote) as they occur.
	// Supported since etcd 3.7.
	MemberWatch(*MemberWatchRequest, Cluster_MemberWatchServer) error
}
...
func (*UnimplementedClusterServer) MemberWatch(req *MemberWatchRequest, srv Cluster_MemberWatchServer) error {
	return status.Errorf(codes.Unimplemented, "method MemberWatch not implemented")
}
...
func _Cluster_MemberWatch_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(MemberWatchRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ClusterServer).MemberWatch(m, &clusterMemberWatchServer{stream})
}

type Cluster_MemberWatchServer interface {
	Send(*MemberWatchResponse) error
	grpc.ServerStream
}

type clusterMemberWatchServer struct {
	grpc.ServerStream
}

func (x *clusterMemberWatchServer) Send(m *MemberWatchResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var _Cluster_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "MemberWatch",
			Handler:       _Cluster_MemberWatch_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "rpc.proto",
...
func (m *MemberWatchRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MemberWatchRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MemberWatchRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MemberWatchResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MemberWatchResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MemberWatchResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MemberWatchRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MemberWatchResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MemberWatchRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MemberWatchRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MemberWatchRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IncludeCurrentMembers", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IncludeCurrentMembers = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipRpc(dAtA[iNdEx:])
			if err != nil {
...
func (m *MemberWatchResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MemberWatchResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MemberWatchResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= MemberEventType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
