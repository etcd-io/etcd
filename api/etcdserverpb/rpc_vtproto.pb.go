...
func (m *DowngradeVersionTestRequest) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *DowngradeVersionTestRequest) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *DowngradeVersionTestRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *StatusResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.DowngradeInfo != nil {
		size, err := m.DowngradeInfo.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *DowngradeInfo) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *DowngradeInfo) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *DowngradeInfo) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *AuthUserAddRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.HashedPassword) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.HashedPassword)))
		i--
		dAtA[i] = 0x22
	}
	if m.Options != nil {
...
func (m *AuthStatusResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.AuthRevision != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.AuthRevision))
		i--
		dAtA[i] = 0x18
	}
	if m.Enabled {
...
func (m *RangeStreamResponse) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *RangeStreamResponse) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *RangeStreamResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.RangeResponse != nil {
		size, err := m.RangeResponse.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *DowngradeVersionTestRequest) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DowngradeInfo) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AuthStatusResponse) SizeVT() (n int) {
	...
	if m.AuthRevision != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.AuthRevision))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *RangeStreamResponse) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DowngradeVersionTestRequest) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *StatusResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			...
			if err := m.DowngradeInfo.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *DowngradeInfo) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *RangeStreamResponse) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			if err := m.RangeResponse.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
