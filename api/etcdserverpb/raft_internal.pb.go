...
const file_raft_internal_proto_rawDesc = "" +
	"\n" +
	"\x13raft_internal.proto\x12\fetcdserverpb\x1a\x10etcdserver.proto\x1a\trpc.proto\x1a etcd/api/versionpb/version.proto\x1a&etcd/api/membershippb/membership.proto\"r\n" +
	"\rRequestHeader\x12\x0e\n" +
	"\x02ID\x18\x01 \x01(\x04R\x02ID\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12,\n" +
	"\rauth_revision\x18\x03 \x01(\x04B\a\x8a\xb5\x18\x033.1R\fauthRevision:\a\x82\xb5\x18\x033.0\"\xb5\x13\n" +
	"\x13InternalRaftRequest\x123\n" +
	"\x06header\x18d \x01(\v2\x1b.etcdserverpb.RequestHeaderR\x06header\x12\x0e\n" +
	"\x02ID\x18\x01 \x01(\x04R\x02ID\x12%\n" +
	"\x02v2\x18\x02 \x01(\v2\x15.etcdserverpb.RequestR\x02v2\x120\n" +
	...
	"\x16downgrade_version_test\x18\xacM \x01(\v2).etcdserverpb.DowngradeVersionTestRequestB\a\x8a\xb5\x18\x033.6R\x14downgradeVersionTest:\a\x82\xb5\x18\x033.0\"\x0f\n" +
	"\rEmptyResponse\"y\n" +
...
var file_raft_internal_proto_goTypes = []any{
	...
	(*DowngradeVersionTestRequest)(nil),              // 33: etcdserverpb.DowngradeVersionTestRequest
}
var file_raft_internal_proto_depIdxs = []int32{
	...
	33, // 31: etcdserverpb.InternalRaftRequest.downgrade_version_test:type_name -> etcdserverpb.DowngradeVersionTestRequest
