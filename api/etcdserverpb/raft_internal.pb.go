...
type InternalRaftRequest struct {
	...
	LeaseRenew               *LeaseKeepAliveRequest                    `protobuf:"bytes,12,opt,name=lease_renew,json=leaseRenew,proto3" json:"lease_renew,omitempty"`
...
var fileDescriptor_b4c9a9be0cfca103 = []byte{
	...
	,
}
...
func (m *InternalRaftRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LeaseRenew != nil {
		{
			size, err := m.LeaseRenew.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *InternalRaftRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LeaseRenew", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.LeaseRenew == nil {
				m.LeaseRenew = &LeaseKeepAliveRequest{}
			}
			if err := m.LeaseRenew.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 100:
