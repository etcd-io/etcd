...
func (m *InternalRaftRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.DowngradeInfoSet != nil {
		if marshalto, ok := interface{}(m.DowngradeInfoSet).(interface {
	...
	if m.ClusterMemberAttrSet != nil {
		if marshalto, ok := interface{}(m.ClusterMemberAttrSet).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
	...
	if m.ClusterVersionSet != nil {
		if marshalto, ok := interface{}(m.ClusterVersionSet).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
