...
func (m *UserAddOptions) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *Permission) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.PermType != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.PermType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *UserAddOptions) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Permission) SizeVT() (n int) {
	...
	_ = l
	if m.PermType != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.PermType))
	}
	l = len(m.Key)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
...
func (m *UserAddOptions) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *Role) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.KeyPermission[len(m.KeyPermission)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
