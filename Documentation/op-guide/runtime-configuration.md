...
Learner can only be promoted to voting member if it is caught up with leader.
```
$ etcdctl member promote 9bf1b35fc7761a23
Error: etcdserver: can only promote a learner member which catches up with leader
```
