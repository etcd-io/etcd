...
type RequestUnion struct {
	...
	//
	// Types that are valid to be assigned to OneofRequest:
	//	*RequestUnion_RequestRange
	//	*RequestUnion_RequestPut
	//	*RequestUnion_RequestDeleteRange
	OneofRequest isRequestUnion_OneofRequest `protobuf_oneof:"oneof_request"`
}
...
type isRequestUnion_OneofRequest interface {
	isRequestUnion_OneofRequest()
...
func (*RequestUnion_RequestRange) isRequestUnion_OneofRequest()       {}
func (*RequestUnion_RequestPut) isRequestUnion_OneofRequest()         {}
func (*RequestUnion_RequestDeleteRange) isRequestUnion_OneofRequest() {}

func (m *RequestUnion) GetOneofRequest() isRequestUnion_OneofRequest {
	if m != nil {
		return m.OneofRequest
	}
	return nil
}

func (m *RequestUnion) GetRequestRange() *RangeRequest {
	if x, ok := m.GetOneofRequest().(*RequestUnion_RequestRange); ok {
...
func (m *RequestUnion) GetRequestPut() *PutRequest {
	if x, ok := m.GetOneofRequest().(*RequestUnion_RequestPut); ok {
		return x.RequestPut
	}
	return nil
}
...
func (m *RequestUnion) GetRequestDeleteRange() *DeleteRangeRequest {
	if x, ok := m.GetOneofRequest().(*RequestUnion_RequestDeleteRange); ok {
...
func _RequestUnion_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case nil:
	default:
		return fmt.Errorf("RequestUnion.OneofRequest has unexpected type %T", x)
	}
	return nil
}
...
func _RequestUnion_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*RequestUnion)
	switch tag {
	case 1: // oneof_request.request_range
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RangeRequest)
		err := b.DecodeMessage(msg)
		m.OneofRequest = &RequestUnion_RequestRange{msg}
		return true, err
	case 2: // oneof_request.request_put
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(PutRequest)
		err := b.DecodeMessage(msg)
		m.OneofRequest = &RequestUnion_RequestPut{msg}
		return true, err
	case 3: // oneof_request.request_delete_range
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(DeleteRangeRequest)
		err := b.DecodeMessage(msg)
		m.OneofRequest = &RequestUnion_RequestDeleteRange{msg}
		return true, err
	default:
		return false, nil
	}
...
type ResponseUnion struct {
	...
	//
	// Types that are valid to be assigned to OneofResponse:
	//	*ResponseUnion_ResponseRange
	//	*ResponseUnion_ResponsePut
	//	*ResponseUnion_ResponseDeleteRange
	OneofResponse isResponseUnion_OneofResponse `protobuf_oneof:"oneof_response"`
}
...
type isResponseUnion_OneofResponse interface {
	isResponseUnion_OneofResponse()
	MarshalTo([]byte) (int, error)
	Size() int
}
...
func (*ResponseUnion_ResponseRange) isResponseUnion_OneofResponse()       {}
func (*ResponseUnion_ResponsePut) isResponseUnion_OneofResponse()         {}
func (*ResponseUnion_ResponseDeleteRange) isResponseUnion_OneofResponse() {}

func (m *ResponseUnion) GetOneofResponse() isResponseUnion_OneofResponse {
	if m != nil {
		return m.OneofResponse
	}
	return nil
}

func (m *ResponseUnion) GetResponseRange() *RangeResponse {
	if x, ok := m.GetOneofResponse().(*ResponseUnion_ResponseRange); ok {
...
func (m *ResponseUnion) GetResponsePut() *PutResponse {
	if x, ok := m.GetOneofResponse().(*ResponseUnion_ResponsePut); ok {
...
func (m *ResponseUnion) GetResponseDeleteRange() *DeleteRangeResponse {
	if x, ok := m.GetOneofResponse().(*ResponseUnion_ResponseDeleteRange); ok {
...
func _ResponseUnion_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case nil:
	default:
		return fmt.Errorf("ResponseUnion.OneofResponse has unexpected type %T", x)
	}
	return nil
}
...
func _ResponseUnion_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ResponseUnion)
	switch tag {
	case 1: // oneof_response.response_range
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RangeResponse)
		err := b.DecodeMessage(msg)
		m.OneofResponse = &ResponseUnion_ResponseRange{msg}
		return true, err
	case 2: // oneof_response.response_put
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(PutResponse)
		err := b.DecodeMessage(msg)
		m.OneofResponse = &ResponseUnion_ResponsePut{msg}
		return true, err
	case 3: // oneof_response.response_delete_range
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(DeleteRangeResponse)
		err := b.DecodeMessage(msg)
		m.OneofResponse = &ResponseUnion_ResponseDeleteRange{msg}
		return true, err
	default:
		return false, nil
	}
...
type Compare struct {
	...
	// Types that are valid to be assigned to OneofTargetUnion:
	//	*Compare_Version
	//	*Compare_CreateRevision
	//	*Compare_ModRevision
	//	*Compare_Value
	OneofTargetUnion isCompare_OneofTargetUnion `protobuf_oneof:"oneof_target_union"`
}
...
type isCompare_OneofTargetUnion interface {
	isCompare_OneofTargetUnion()
	MarshalTo([]byte) (int, error)
	Size() int
}
...
func (*Compare_Version) isCompare_OneofTargetUnion()        {}
func (*Compare_CreateRevision) isCompare_OneofTargetUnion() {}
func (*Compare_ModRevision) isCompare_OneofTargetUnion()    {}
func (*Compare_Value) isCompare_OneofTargetUnion()          {}

func (m *Compare) GetOneofTargetUnion() isCompare_OneofTargetUnion {
	if m != nil {
		return m.OneofTargetUnion
	}
	return nil
}

func (m *Compare) GetVersion() int64 {
	if x, ok := m.GetOneofTargetUnion().(*Compare_Version); ok {
		return x.Version
	}
	return 0
}
...
func (m *Compare) GetCreateRevision() int64 {
	if x, ok := m.GetOneofTargetUnion().(*Compare_CreateRevision); ok {
...
func (m *Compare) GetModRevision() int64 {
	if x, ok := m.GetOneofTargetUnion().(*Compare_ModRevision); ok {
...
func (m *Compare) GetValue() []byte {
	if x, ok := m.GetOneofTargetUnion().(*Compare_Value); ok {
		return x.Value
	}
	return nil
}
...
func _Compare_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*Compare)
	// oneof_target_union
	switch x := m.OneofTargetUnion.(type) {
	...
	case nil:
	default:
		return fmt.Errorf("Compare.OneofTargetUnion has unexpected type %T", x)
	}
	return nil
}
...
func _Compare_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Compare)
	switch tag {
	case 4: // oneof_target_union.version
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.OneofTargetUnion = &Compare_Version{int64(x)}
		return true, err
	case 5: // oneof_target_union.create_revision
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.OneofTargetUnion = &Compare_CreateRevision{int64(x)}
		return true, err
	case 6: // oneof_target_union.mod_revision
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.OneofTargetUnion = &Compare_ModRevision{int64(x)}
		return true, err
	case 7: // oneof_target_union.value
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeRawBytes(true)
		m.OneofTargetUnion = &Compare_Value{x}
		return true, err
	default:
		return false, nil
	}
...
type WatchRequest struct {
	...
	//
	// Types that are valid to be assigned to OneofRequestUnion:
	//	*WatchRequest_CreateRequest
	//	*WatchRequest_CancelRequest
	OneofRequestUnion isWatchRequest_OneofRequestUnion `protobuf_oneof:"oneof_request_union"`
}
...
type isWatchRequest_OneofRequestUnion interface {
	isWatchRequest_OneofRequestUnion()
	MarshalTo([]byte) (int, error)
	Size() int
}
...
func (*WatchRequest_CreateRequest) isWatchRequest_OneofRequestUnion() {}
func (*WatchRequest_CancelRequest) isWatchRequest_OneofRequestUnion() {}

func (m *WatchRequest) GetOneofRequestUnion() isWatchRequest_OneofRequestUnion {
	if m != nil {
		return m.OneofRequestUnion
	}
	return nil
}

func (m *WatchRequest) GetCreateRequest() *WatchCreateRequest {
	if x, ok := m.GetOneofRequestUnion().(*WatchRequest_CreateRequest); ok {
...
func (m *WatchRequest) GetCancelRequest() *WatchCancelRequest {
	if x, ok := m.GetOneofRequestUnion().(*WatchRequest_CancelRequest); ok {
...
func _WatchRequest_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*WatchRequest)
	// oneof_request_union
	switch x := m.OneofRequestUnion.(type) {
	...
	case nil:
	default:
		return fmt.Errorf("WatchRequest.OneofRequestUnion has unexpected type %T", x)
	}
	return nil
}
...
func _WatchRequest_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*WatchRequest)
	switch tag {
	case 1: // oneof_request_union.create_request
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(WatchCreateRequest)
		err := b.DecodeMessage(msg)
		m.OneofRequestUnion = &WatchRequest_CreateRequest{msg}
		return true, err
	case 2: // oneof_request_union.cancel_request
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(WatchCancelRequest)
		err := b.DecodeMessage(msg)
		m.OneofRequestUnion = &WatchRequest_CancelRequest{msg}
		return true, err
	default:
		return false, nil
	}
...
func (m *RequestUnion) MarshalTo(data []byte) (int, error) {
	...
	var l int
	_ = l
	if m.OneofRequest != nil {
		nn4, err := m.OneofRequest.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn4
...
func (m *ResponseUnion) MarshalTo(data []byte) (int, error) {
	...
	var l int
	_ = l
	if m.OneofResponse != nil {
		nn8, err := m.OneofResponse.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn8
...
func (m *Compare) MarshalTo(data []byte) (int, error) {
	...
	if m.OneofTargetUnion != nil {
		nn12, err := m.OneofTargetUnion.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn12
...
func (m *WatchRequest) MarshalTo(data []byte) (int, error) {
	...
	var l int
	_ = l
	if m.OneofRequestUnion != nil {
		nn17, err := m.OneofRequestUnion.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn17
...
func (m *RequestUnion) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.OneofRequest = &RequestUnion_RequestRange{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.OneofRequest = &RequestUnion_RequestPut{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.OneofRequest = &RequestUnion_RequestDeleteRange{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRpc(data[iNdEx:])
...
func (m *ResponseUnion) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.OneofResponse = &ResponseUnion_ResponseRange{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.OneofResponse = &ResponseUnion_ResponsePut{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.OneofResponse = &ResponseUnion_ResponseDeleteRange{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRpc(data[iNdEx:])
...
func (m *Compare) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.OneofTargetUnion = &Compare_Version{v}
		case 5:
			if wireType != 0 {
			...
			m.OneofTargetUnion = &Compare_CreateRevision{v}
		case 6:
			if wireType != 0 {
			...
			m.OneofTargetUnion = &Compare_ModRevision{v}
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Value", wireType)
			}
			...
			m.OneofTargetUnion = &Compare_Value{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRpc(data[iNdEx:])
...
func (m *WatchRequest) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.OneofRequestUnion = &WatchRequest_CreateRequest{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.OneofRequestUnion = &WatchRequest_CancelRequest{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRpc(data[iNdEx:])
...
var fileDescriptorRpc = []byte{
	...
	,
}
