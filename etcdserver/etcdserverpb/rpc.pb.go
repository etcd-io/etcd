...
type RangeResponse struct {
	...
	More int64 `protobuf:"varint,3,opt,name=more,proto3" json:"more,omitempty"`
}
...
func (m *RangeResponse) MarshalTo(data []byte) (int, error) {
	...
	if m.More != 0 {
		data[i] = 0x18
		i++
		i = encodeVarintRpc(data, i, uint64(m.More))
	}
	return i, nil
}
