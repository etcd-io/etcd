...
import (
	...
	qospb "go.etcd.io/etcd/v3/qos/qospb"
...
func (m *QoSEnableRequest) Reset()                    { *m = QoSEnableRequest{} }
func (m *QoSEnableRequest) String() string            { return proto.CompactTextString(m) }
func (*QoSEnableRequest) ProtoMessage()               {}
func (*QoSEnableRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{95} }

type QoSDisableRequest struct {
}

func (m *QoSDisableRequest) Reset()                    { *m = QoSDisableRequest{} }
func (m *QoSDisableRequest) String() string            { return proto.CompactTextString(m) }
func (*QoSDisableRequest) ProtoMessage()               {}
func (*QoSDisableRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{96} }

type QoSEnableResponse struct {
	Header *ResponseHeader `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
}

func (m *QoSEnableResponse) Reset()                    { *m = QoSEnableResponse{} }
func (m *QoSEnableResponse) String() string            { return proto.CompactTextString(m) }
func (*QoSEnableResponse) ProtoMessage()               {}
func (*QoSEnableResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{97} }

func (m *QoSEnableResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
type QoSDisableResponse struct {
	Header *ResponseHeader `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
}

func (m *QoSDisableResponse) Reset()                    { *m = QoSDisableResponse{} }
func (m *QoSDisableResponse) String() string            { return proto.CompactTextString(m) }
func (*QoSDisableResponse) ProtoMessage()               {}
func (*QoSDisableResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{98} }

func (m *QoSDisableResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
type QoSRuleAddRequest struct {
	QosRule *qospb.QoSRule `protobuf:"bytes,1,opt,name=qos_rule,json=qosRule" json:"qos_rule,omitempty"`
}

func (m *QoSRuleAddRequest) Reset()                    { *m = QoSRuleAddRequest{} }
func (m *QoSRuleAddRequest) String() string            { return proto.CompactTextString(m) }
func (*QoSRuleAddRequest) ProtoMessage()               {}
func (*QoSRuleAddRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{99} }

func (m *QoSRuleAddRequest) GetQosRule() *qospb.QoSRule {
	if m != nil {
		return m.QosRule
	}
	return nil
...
func (m *QoSRuleAddResponse) Reset()                    { *m = QoSRuleAddResponse{} }
func (m *QoSRuleAddResponse) String() string            { return proto.CompactTextString(m) }
func (*QoSRuleAddResponse) ProtoMessage()               {}
func (*QoSRuleAddResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{100} }

func (m *QoSRuleAddResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
type QoSRuleDeleteRequest struct {
	RuleName string `protobuf:"bytes,1,opt,name=rule_name,json=ruleName,proto3" json:"rule_name,omitempty"`
}

func (m *QoSRuleDeleteRequest) Reset()                    { *m = QoSRuleDeleteRequest{} }
func (m *QoSRuleDeleteRequest) String() string            { return proto.CompactTextString(m) }
func (*QoSRuleDeleteRequest) ProtoMessage()               {}
func (*QoSRuleDeleteRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{101} }

func (m *QoSRuleDeleteRequest) GetRuleName() string {
	if m != nil {
		return m.RuleName
	}
	return ""
...
type QoSRuleDeleteResponse struct {
	Header *ResponseHeader `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
}

func (m *QoSRuleDeleteResponse) Reset()                    { *m = QoSRuleDeleteResponse{} }
func (m *QoSRuleDeleteResponse) String() string            { return proto.CompactTextString(m) }
func (*QoSRuleDeleteResponse) ProtoMessage()               {}
func (*QoSRuleDeleteResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{102} }

func (m *QoSRuleDeleteResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
type QoSRuleGetRequest struct {
	RuleName string `protobuf:"bytes,1,opt,name=rule_name,json=ruleName,proto3" json:"rule_name,omitempty"`
}

func (m *QoSRuleGetRequest) Reset()                    { *m = QoSRuleGetRequest{} }
func (m *QoSRuleGetRequest) String() string            { return proto.CompactTextString(m) }
func (*QoSRuleGetRequest) ProtoMessage()               {}
func (*QoSRuleGetRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{103} }

func (m *QoSRuleGetRequest) GetRuleName() string {
	if m != nil {
		return m.RuleName
	}
	return ""
...
type QoSRuleGetResponse struct {
	Header  *ResponseHeader `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
	QosRule *qospb.QoSRule  `protobuf:"bytes,2,opt,name=qos_rule,json=qosRule" json:"qos_rule,omitempty"`
}

func (m *QoSRuleGetResponse) Reset()                    { *m = QoSRuleGetResponse{} }
func (m *QoSRuleGetResponse) String() string            { return proto.CompactTextString(m) }
func (*QoSRuleGetResponse) ProtoMessage()               {}
func (*QoSRuleGetResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{104} }

func (m *QoSRuleGetResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *QoSRuleGetResponse) GetQosRule() *qospb.QoSRule {
	if m != nil {
		return m.QosRule
	}
	return nil
...
type QoSRuleUpdateRequest struct {
	QosRule *qospb.QoSRule `protobuf:"bytes,1,opt,name=qos_rule,json=qosRule" json:"qos_rule,omitempty"`
}

func (m *QoSRuleUpdateRequest) Reset()                    { *m = QoSRuleUpdateRequest{} }
func (m *QoSRuleUpdateRequest) String() string            { return proto.CompactTextString(m) }
func (*QoSRuleUpdateRequest) ProtoMessage()               {}
func (*QoSRuleUpdateRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{105} }

func (m *QoSRuleUpdateRequest) GetQosRule() *qospb.QoSRule {
	if m != nil {
		return m.QosRule
	}
	return nil
...
type QoSRuleUpdateResponse struct {
	Header *ResponseHeader `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
}

func (m *QoSRuleUpdateResponse) Reset()                    { *m = QoSRuleUpdateResponse{} }
func (m *QoSRuleUpdateResponse) String() string            { return proto.CompactTextString(m) }
func (*QoSRuleUpdateResponse) ProtoMessage()               {}
func (*QoSRuleUpdateResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{106} }

func (m *QoSRuleUpdateResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
type QoSRuleListRequest struct {
}

func (m *QoSRuleListRequest) Reset()                    { *m = QoSRuleListRequest{} }
func (m *QoSRuleListRequest) String() string            { return proto.CompactTextString(m) }
func (*QoSRuleListRequest) ProtoMessage()               {}
func (*QoSRuleListRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{107} }

type QoSRuleListResponse struct {
	Header   *ResponseHeader  `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
	QosRules []*qospb.QoSRule `protobuf:"bytes,2,rep,name=qos_rules,json=qosRules" json:"qos_rules,omitempty"`
}

func (m *QoSRuleListResponse) Reset()                    { *m = QoSRuleListResponse{} }
func (m *QoSRuleListResponse) String() string            { return proto.CompactTextString(m) }
func (*QoSRuleListResponse) ProtoMessage()               {}
func (*QoSRuleListResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{108} }

func (m *QoSRuleListResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *QoSRuleListResponse) GetQosRules() []*qospb.QoSRule {
	if m != nil {
		return m.QosRules
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QoSEnableRequest)(nil), "etcdserverpb.QoSEnableRequest")
	proto.RegisterType((*QoSDisableRequest)(nil), "etcdserverpb.QoSDisableRequest")
	proto.RegisterType((*QoSEnableResponse)(nil), "etcdserverpb.QoSEnableResponse")
	proto.RegisterType((*QoSDisableResponse)(nil), "etcdserverpb.QoSDisableResponse")
	proto.RegisterType((*QoSRuleAddRequest)(nil), "etcdserverpb.QoSRuleAddRequest")
	proto.RegisterType((*QoSRuleAddResponse)(nil), "etcdserverpb.QoSRuleAddResponse")
	proto.RegisterType((*QoSRuleDeleteRequest)(nil), "etcdserverpb.QoSRuleDeleteRequest")
	proto.RegisterType((*QoSRuleDeleteResponse)(nil), "etcdserverpb.QoSRuleDeleteResponse")
	proto.RegisterType((*QoSRuleGetRequest)(nil), "etcdserverpb.QoSRuleGetRequest")
	proto.RegisterType((*QoSRuleGetResponse)(nil), "etcdserverpb.QoSRuleGetResponse")
	proto.RegisterType((*QoSRuleUpdateRequest)(nil), "etcdserverpb.QoSRuleUpdateRequest")
	proto.RegisterType((*QoSRuleUpdateResponse)(nil), "etcdserverpb.QoSRuleUpdateResponse")
	proto.RegisterType((*QoSRuleListRequest)(nil), "etcdserverpb.QoSRuleListRequest")
	proto.RegisterType((*QoSRuleListResponse)(nil), "etcdserverpb.QoSRuleListResponse")
...
type QoSClient interface {
	...
	QoSEnable(ctx context.Context, in *QoSEnableRequest, opts ...grpc.CallOption) (*QoSEnableResponse, error)
	// QoSDisable disables qos.
	QoSDisable(ctx context.Context, in *QoSDisableRequest, opts ...grpc.CallOption) (*QoSDisableResponse, error)
	// QoSRuleAdd adds a qos rule into the cluster.
	QoSRuleAdd(ctx context.Context, in *QoSRuleAddRequest, opts ...grpc.CallOption) (*QoSRuleAddResponse, error)
	// QoSRuleGet get a qos rule into the cluster.
	QoSRuleGet(ctx context.Context, in *QoSRuleGetRequest, opts ...grpc.CallOption) (*QoSRuleGetResponse, error)
	// QoSRuleDelete deletes a qos rule from the cluster.
	QoSRuleDelete(ctx context.Context, in *QoSRuleDeleteRequest, opts ...grpc.CallOption) (*QoSRuleDeleteResponse, error)
	// QoSRuleUpdate updates a qos rule into the cluster.
	QoSRuleUpdate(ctx context.Context, in *QoSRuleUpdateRequest, opts ...grpc.CallOption) (*QoSRuleUpdateResponse, error)
	// QoSRuleList lists all qos rule from the cluster.
	QoSRuleList(ctx context.Context, in *QoSRuleListRequest, opts ...grpc.CallOption) (*QoSRuleListResponse, error)
}
...
func (c *qoSClient) QoSEnable(ctx context.Context, in *QoSEnableRequest, opts ...grpc.CallOption) (*QoSEnableResponse, error) {
	out := new(QoSEnableResponse)
	err := grpc.Invoke(ctx, "/etcdserverpb.QoS/QoSEnable", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *qoSClient) QoSDisable(ctx context.Context, in *QoSDisableRequest, opts ...grpc.CallOption) (*QoSDisableResponse, error) {
	out := new(QoSDisableResponse)
	err := grpc.Invoke(ctx, "/etcdserverpb.QoS/QoSDisable", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *qoSClient) QoSRuleAdd(ctx context.Context, in *QoSRuleAddRequest, opts ...grpc.CallOption) (*QoSRuleAddResponse, error) {
	out := new(QoSRuleAddResponse)
	err := grpc.Invoke(ctx, "/etcdserverpb.QoS/QoSRuleAdd", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *qoSClient) QoSRuleGet(ctx context.Context, in *QoSRuleGetRequest, opts ...grpc.CallOption) (*QoSRuleGetResponse, error) {
	out := new(QoSRuleGetResponse)
	err := grpc.Invoke(ctx, "/etcdserverpb.QoS/QoSRuleGet", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *qoSClient) QoSRuleDelete(ctx context.Context, in *QoSRuleDeleteRequest, opts ...grpc.CallOption) (*QoSRuleDeleteResponse, error) {
	out := new(QoSRuleDeleteResponse)
	err := grpc.Invoke(ctx, "/etcdserverpb.QoS/QoSRuleDelete", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *qoSClient) QoSRuleUpdate(ctx context.Context, in *QoSRuleUpdateRequest, opts ...grpc.CallOption) (*QoSRuleUpdateResponse, error) {
	out := new(QoSRuleUpdateResponse)
	err := grpc.Invoke(ctx, "/etcdserverpb.QoS/QoSRuleUpdate", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *qoSClient) QoSRuleList(ctx context.Context, in *QoSRuleListRequest, opts ...grpc.CallOption) (*QoSRuleListResponse, error) {
	out := new(QoSRuleListResponse)
	err := grpc.Invoke(ctx, "/etcdserverpb.QoS/QoSRuleList", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QoSServer interface {
	// QoSEnable enables qos.
	QoSEnable(context.Context, *QoSEnableRequest) (*QoSEnableResponse, error)
	// QoSDisable disables qos.
	QoSDisable(context.Context, *QoSDisableRequest) (*QoSDisableResponse, error)
	// QoSRuleAdd adds a qos rule into the cluster.
	QoSRuleAdd(context.Context, *QoSRuleAddRequest) (*QoSRuleAddResponse, error)
	// QoSRuleGet get a qos rule into the cluster.
	QoSRuleGet(context.Context, *QoSRuleGetRequest) (*QoSRuleGetResponse, error)
	// QoSRuleDelete deletes a qos rule from the cluster.
	QoSRuleDelete(context.Context, *QoSRuleDeleteRequest) (*QoSRuleDeleteResponse, error)
	// QoSRuleUpdate updates a qos rule into the cluster.
	QoSRuleUpdate(context.Context, *QoSRuleUpdateRequest) (*QoSRuleUpdateResponse, error)
	// QoSRuleList lists all qos rule from the cluster.
	QoSRuleList(context.Context, *QoSRuleListRequest) (*QoSRuleListResponse, error)
}
...
func _QoS_QoSEnable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QoSEnableRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QoSServer).QoSEnable(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/etcdserverpb.QoS/QoSEnable",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QoSServer).QoSEnable(ctx, req.(*QoSEnableRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _QoS_QoSDisable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QoSDisableRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QoSServer).QoSDisable(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/etcdserverpb.QoS/QoSDisable",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QoSServer).QoSDisable(ctx, req.(*QoSDisableRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _QoS_QoSRuleAdd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QoSRuleAddRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QoSServer).QoSRuleAdd(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/etcdserverpb.QoS/QoSRuleAdd",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QoSServer).QoSRuleAdd(ctx, req.(*QoSRuleAddRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _QoS_QoSRuleGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QoSRuleGetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QoSServer).QoSRuleGet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/etcdserverpb.QoS/QoSRuleGet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QoSServer).QoSRuleGet(ctx, req.(*QoSRuleGetRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _QoS_QoSRuleDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QoSRuleDeleteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QoSServer).QoSRuleDelete(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/etcdserverpb.QoS/QoSRuleDelete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QoSServer).QoSRuleDelete(ctx, req.(*QoSRuleDeleteRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _QoS_QoSRuleUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QoSRuleUpdateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QoSServer).QoSRuleUpdate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/etcdserverpb.QoS/QoSRuleUpdate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QoSServer).QoSRuleUpdate(ctx, req.(*QoSRuleUpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _QoS_QoSRuleList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QoSRuleListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QoSServer).QoSRuleList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/etcdserverpb.QoS/QoSRuleList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QoSServer).QoSRuleList(ctx, req.(*QoSRuleListRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _QoS_serviceDesc = grpc.ServiceDesc{
	ServiceName: "etcdserverpb.QoS",
	HandlerType: (*QoSServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "QoSEnable",
			Handler:    _QoS_QoSEnable_Handler,
		},
		{
			MethodName: "QoSDisable",
			Handler:    _QoS_QoSDisable_Handler,
		},
		{
			MethodName: "QoSRuleAdd",
			Handler:    _QoS_QoSRuleAdd_Handler,
		},
		{
			MethodName: "QoSRuleGet",
			Handler:    _QoS_QoSRuleGet_Handler,
		},
		{
			MethodName: "QoSRuleDelete",
			Handler:    _QoS_QoSRuleDelete_Handler,
		},
		{
			MethodName: "QoSRuleUpdate",
			Handler:    _QoS_QoSRuleUpdate_Handler,
		},
		{
			MethodName: "QoSRuleList",
			Handler:    _QoS_QoSRuleList_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "rpc.proto",
...
func (m *QoSEnableRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QoSEnableRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *QoSDisableRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QoSDisableRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *QoSEnableResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QoSEnableResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *QoSDisableResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QoSDisableResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *QoSRuleAddRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QoSRuleAddRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.QosRule != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintRpc(dAtA, i, uint64(m.QosRule.Size()))
		n66, err := m.QosRule.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n66
...
func (m *QoSRuleAddResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QoSRuleAddResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *QoSRuleDeleteRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QoSRuleDeleteRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *QoSRuleDeleteResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QoSRuleDeleteResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *QoSRuleGetRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QoSRuleGetRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *QoSRuleGetResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QoSRuleGetResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.QosRule != nil {
		...
		i++
		i = encodeVarintRpc(dAtA, i, uint64(m.QosRule.Size()))
		n70, err := m.QosRule.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n70
...
func (m *QoSRuleUpdateRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QoSRuleUpdateRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.QosRule != nil {
		...
		i++
		i = encodeVarintRpc(dAtA, i, uint64(m.QosRule.Size()))
		n71, err := m.QosRule.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n71
...
func (m *QoSRuleUpdateResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QoSRuleUpdateResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *QoSRuleListRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QoSRuleListRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *QoSRuleListResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QoSRuleListResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *QoSEnableRequest) Size() (n int) {
	var l int
	_ = l
	return n
}

func (m *QoSDisableRequest) Size() (n int) {
	var l int
	_ = l
	return n
}

func (m *QoSEnableResponse) Size() (n int) {
	var l int
	_ = l
	if m.Header != nil {
		l = m.Header.Size()
...
func (m *QoSDisableResponse) Size() (n int) {
	var l int
	_ = l
	if m.Header != nil {
		l = m.Header.Size()
...
func (m *QoSRuleAddRequest) Size() (n int) {
	var l int
	_ = l
	if m.QosRule != nil {
		l = m.QosRule.Size()
...
func (m *QoSRuleAddResponse) Size() (n int) {
	var l int
	_ = l
	if m.Header != nil {
		l = m.Header.Size()
...
func (m *QoSRuleDeleteRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.RuleName)
	if l > 0 {
...
func (m *QoSRuleDeleteResponse) Size() (n int) {
	var l int
	_ = l
	if m.Header != nil {
		l = m.Header.Size()
...
func (m *QoSRuleGetRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.RuleName)
	if l > 0 {
...
func (m *QoSRuleGetResponse) Size() (n int) {
	var l int
	_ = l
	if m.Header != nil {
		l = m.Header.Size()
...
func (m *QoSRuleUpdateRequest) Size() (n int) {
	var l int
	_ = l
	if m.QosRule != nil {
		l = m.QosRule.Size()
...
func (m *QoSRuleUpdateResponse) Size() (n int) {
	var l int
	_ = l
	if m.Header != nil {
		l = m.Header.Size()
...
func (m *QoSRuleListRequest) Size() (n int) {
	var l int
	_ = l
	return n
}

func (m *QoSRuleListResponse) Size() (n int) {
	var l int
	_ = l
	if m.Header != nil {
		l = m.Header.Size()
...
func (m *QoSEnableRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QoSEnableRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QoSEnableRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *QoSDisableRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QoSDisableRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QoSDisableRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *QoSEnableResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QoSEnableResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QoSEnableResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QoSDisableResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QoSDisableResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QoSDisableResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QoSRuleAddRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QoSRuleAddRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QoSRuleAddRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QosRule", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.QosRule == nil {
				m.QosRule = &qospb.QoSRule{}
			}
			if err := m.QosRule.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *QoSRuleAddResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QoSRuleAddResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QoSRuleAddResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QoSRuleDeleteRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QoSRuleDeleteRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QoSRuleDeleteRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QoSRuleDeleteResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QoSRuleDeleteResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QoSRuleDeleteResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QoSRuleGetRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QoSRuleGetRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QoSRuleGetRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QoSRuleGetResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QoSRuleGetResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QoSRuleGetResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QoSRuleUpdateRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QoSRuleUpdateRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QoSRuleUpdateRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QoSRuleUpdateResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QoSRuleUpdateResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QoSRuleUpdateResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QoSRuleListRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QoSRuleListRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QoSRuleListRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *QoSRuleListResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QoSRuleListResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QoSRuleListResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QosRules", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.QosRules = append(m.QosRules, &qospb.QoSRule{})
			if err := m.QosRules[len(m.QosRules)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorRpc = []byte{
	...
	,
}
