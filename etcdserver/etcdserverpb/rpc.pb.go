...
func (Compare_CompareResult) EnumDescriptor() ([]byte, []int) { return fileDescriptorRpc, []int{11, 0} }
...
func (Compare_CompareTarget) EnumDescriptor() ([]byte, []int) { return fileDescriptorRpc, []int{11, 1} }
...
func (WatchCreateRequest_FilterType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorRpc, []int{23, 0}
}
...
func (m *RangeStreamRequest) Reset()                    { *m = RangeStreamRequest{} }
func (m *RangeStreamRequest) String() string            { return proto.CompactTextString(m) }
func (*RangeStreamRequest) ProtoMessage()               {}
func (*RangeStreamRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{2} }

func (m *RangeStreamRequest) GetKey() []byte {
	if m != nil {
		return m.Key
	}
	return nil
...
func (m *RangeStreamRequest) GetRangeEnd() []byte {
	if m != nil {
		return m.RangeEnd
	}
	return nil
...
func (m *RangeStreamRequest) GetLimit() int64 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func (m *RangeStreamRequest) GetRevision() int64 {
	if m != nil {
		return m.Revision
	}
	return 0
...
func (m *RangeStreamRequest) GetSerializable() bool {
	if m != nil {
		return m.Serializable
	}
	return false
...
func (m *RangeStreamRequest) GetKeysOnly() bool {
	if m != nil {
		return m.KeysOnly
	}
	return false
...
func (*RangeResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{3} }
...
func (*RangeStreamResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{4} }

func (m *RangeStreamResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *RangeStreamResponse) GetKvs() []*mvccpb.KeyValue {
	if m != nil {
		return m.Kvs
	}
	return nil
...
func (m *RangeStreamResponse) GetCount() int64 {
	if m != nil {
		return m.Count
	}
	return 0
...
func (m *RangeStreamResponse) GetTotalCount() int64 {
	if m != nil {
		return m.TotalCount
	}
	return 0
...
func (m *RangeStreamResponse) GetTotalSize() int64 {
	if m != nil {
		return m.TotalSize
	}
	return 0
...
func (*PutRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{5} }
...
func (*PutResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{6} }
...
func (*DeleteRangeRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{7} }
...
func (*DeleteRangeResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{8} }
...
func (*RequestOp) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{9} }
...
type RequestOp_RequestRangeStream struct {
	RequestRangeStream *RangeStreamRequest `protobuf:"bytes,5,opt,name=request_range_stream,json=requestRangeStream,oneof"`
}
...
func (*RequestOp_RequestRangeStream) isRequestOp_Request() {}
...
func (m *RequestOp) GetRequestRangeStream() *RangeStreamRequest {
	if x, ok := m.GetRequest().(*RequestOp_RequestRangeStream); ok {
		return x.RequestRangeStream
	}
	return nil
}
...
func (*RequestOp) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _RequestOp_OneofMarshaler, _RequestOp_OneofUnmarshaler, _RequestOp_OneofSizer, []interface{}{
		...
		(*RequestOp_RequestRangeStream)(nil),
	}
}
...
func _RequestOp_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *RequestOp_RequestRangeStream:
		_ = b.EncodeVarint(5<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RequestRangeStream); err != nil {
			return err
		}
	case nil:
	default:
...
func _RequestOp_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 4: // request.request_txn
		...
		return true, err
	case 5: // request.request_range_stream
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RangeStreamRequest)
		err := b.DecodeMessage(msg)
		m.Request = &RequestOp_RequestRangeStream{msg}
		return true, err
	default:
		return false, nil
	}
...
func _RequestOp_OneofSizer(msg proto.Message) (n int) {
	...
	case *RequestOp_RequestTxn:
		...
		n += s
	case *RequestOp_RequestRangeStream:
		s := proto.Size(x.RequestRangeStream)
...
type ResponseOp struct {
	...
	//	*ResponseOp_ResponseRangeStream
...
func (*ResponseOp) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{10} }
...
type ResponseOp_ResponseRangeStream struct {
	ResponseRangeStream *RangeStreamResponse `protobuf:"bytes,5,opt,name=response_range_stream,json=responseRangeStream,oneof"`
}
...
func (*ResponseOp_ResponseRangeStream) isResponseOp_Response() {}
...
func (m *ResponseOp) GetResponseRangeStream() *RangeStreamResponse {
	if x, ok := m.GetResponse().(*ResponseOp_ResponseRangeStream); ok {
		return x.ResponseRangeStream
	}
	return nil
}
...
func (*ResponseOp) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ResponseOp_OneofMarshaler, _ResponseOp_OneofUnmarshaler, _ResponseOp_OneofSizer, []interface{}{
		...
		(*ResponseOp_ResponseRangeStream)(nil),
	}
}
...
func _ResponseOp_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *ResponseOp_ResponseRangeStream:
		_ = b.EncodeVarint(5<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.ResponseRangeStream); err != nil {
			return err
		}
	case nil:
	default:
...
func _ResponseOp_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 4: // response.response_txn
		...
		return true, err
	case 5: // response.response_range_stream
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RangeStreamResponse)
		err := b.DecodeMessage(msg)
		m.Response = &ResponseOp_ResponseRangeStream{msg}
		return true, err
	default:
		return false, nil
	}
...
func _ResponseOp_OneofSizer(msg proto.Message) (n int) {
	...
	case *ResponseOp_ResponseTxn:
		...
		n += s
	case *ResponseOp_ResponseRangeStream:
		s := proto.Size(x.ResponseRangeStream)
		n += proto.SizeVarint(5<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (*Compare) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{11} }
...
func (*TxnRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{12} }
...
func (*TxnResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{13} }
...
func (*CompactionRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{14} }
...
func (*CompactionResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{15} }
...
func (*HashRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{16} }
...
func (*HashKVRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{17} }
...
func (*HashKVResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{18} }
...
func (*HashResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{19} }
...
func (*SnapshotRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{20} }
...
func (*SnapshotResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{21} }
...
func (*WatchRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{22} }
...
func (*WatchCreateRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{23} }
...
func (*WatchCancelRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{24} }
...
func (*WatchProgressRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{25} }
...
func (*WatchResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{26} }
...
func (*LeaseGrantRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{27} }
...
func (*LeaseGrantResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{28} }
...
func (*LeaseRevokeRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{29} }
...
func (*LeaseRevokeResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{30} }
...
func (*LeaseCheckpoint) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{31} }
...
func (*LeaseCheckpointRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{32} }
...
func (*LeaseCheckpointResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{33} }
...
func (*LeaseKeepAliveRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{34} }
...
func (*LeaseKeepAliveResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{35} }
...
func (*LeaseTimeToLiveRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{36} }
...
func (*LeaseTimeToLiveResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{37} }
...
func (*LeaseLeasesRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{38} }
...
func (*LeaseStatus) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{39} }
...
func (*LeaseLeasesResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{40} }
...
func init() {
	...
	proto.RegisterType((*RangeStreamRequest)(nil), "etcdserverpb.RangeStreamRequest")
...
type KVClient interface {
	...
	// RangeStream gets the keys in the range stream from the key-value store.
	RangeStream(ctx context.Context, in *RangeStreamRequest, opts ...grpc.CallOption) (KV_RangeStreamClient, error)
...
func (c *kVClient) RangeStream(ctx context.Context, in *RangeStreamRequest, opts ...grpc.CallOption) (KV_RangeStreamClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_KV_serviceDesc.Streams[0], c.cc, "/etcdserverpb.KV/RangeStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &kVRangeStreamClient{stream}
...
type KV_RangeStreamClient interface {
	Recv() (*RangeStreamResponse, error)
	grpc.ClientStream
}

type kVRangeStreamClient struct {
	grpc.ClientStream
}

func (x *kVRangeStreamClient) Recv() (*RangeStreamResponse, error) {
	m := new(RangeStreamResponse)
...
type KVServer interface {
	...
	// RangeStream gets the keys in the range stream from the key-value store.
	RangeStream(*RangeStreamRequest, KV_RangeStreamServer) error
	// Put puts the given key into the key-value store.
	// A put request increments the revision of the key-value store
	// and generates one event in the event history.
...
func _KV_RangeStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(RangeStreamRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(KVServer).RangeStream(m, &kVRangeStreamServer{stream})
}

type KV_RangeStreamServer interface {
	Send(*RangeStreamResponse) error
	grpc.ServerStream
}

type kVRangeStreamServer struct {
	grpc.ServerStream
}

func (x *kVRangeStreamServer) Send(m *RangeStreamResponse) error {
...
func (m *RangeStreamRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RangeStreamRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *RangeStreamResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TotalCount != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintRpc(dAtA, i, uint64(m.TotalCount))
	}
	if m.TotalSize != 0 {
		dAtA[i] = 0x30
		i++
		i = encodeVarintRpc(dAtA, i, uint64(m.TotalSize))
	}
	return i, nil
}
...
func (m *PutResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PrevKv != nil {
		...
		n4, err := m.PrevKv.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
func (m *RequestOp_RequestRange) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RequestRange != nil {
		...
		n7, err := m.RequestRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
func (m *RequestOp_RequestPut) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RequestPut != nil {
		...
		n8, err := m.RequestPut.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (m *RequestOp_RequestDeleteRange) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RequestDeleteRange != nil {
		...
		n9, err := m.RequestDeleteRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func (m *RequestOp_RequestTxn) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RequestTxn != nil {
		...
		n10, err := m.RequestTxn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *RequestOp_RequestRangeStream) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.RequestRangeStream != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintRpc(dAtA, i, uint64(m.RequestRangeStream.Size()))
		n11, err := m.RequestRangeStream.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func (m *ResponseOp_ResponseRange) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ResponseRange != nil {
		...
		n13, err := m.ResponseRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *ResponseOp_ResponsePut) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ResponsePut != nil {
		...
		n14, err := m.ResponsePut.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
...
func (m *ResponseOp_ResponseDeleteRange) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ResponseDeleteRange != nil {
		...
		n15, err := m.ResponseDeleteRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *ResponseOp_ResponseTxn) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ResponseTxn != nil {
		...
		n16, err := m.ResponseTxn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *ResponseOp_ResponseRangeStream) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.ResponseRangeStream != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintRpc(dAtA, i, uint64(m.ResponseRangeStream.Size()))
		n17, err := m.ResponseRangeStream.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
...
func (m *Compare) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TargetUnion != nil {
		nn18, err := m.TargetUnion.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn18
...
func (m *WatchRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RequestUnion != nil {
		nn24, err := m.RequestUnion.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn24
...
func (m *WatchRequest_CreateRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CreateRequest != nil {
		...
		n25, err := m.CreateRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
...
func (m *WatchRequest_CancelRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CancelRequest != nil {
		...
		n26, err := m.CancelRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
...
func (m *WatchRequest_ProgressRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ProgressRequest != nil {
		...
		n27, err := m.ProgressRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
...
func (m *WatchCreateRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Filters) > 0 {
		dAtA29 := make([]byte, len(m.Filters)*10)
		var j28 int
		...
		dAtA[i] = 0x2a
		i++
		i = encodeVarintRpc(dAtA, i, uint64(j28))
...
func (m *MemberAddResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Member != nil {
		...
		n38, err := m.Member.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n38
...
func (m *RangeStreamRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.Key)
	if l > 0 {
...
func (m *RangeStreamResponse) Size() (n int) {
	...
	if m.TotalCount != 0 {
		n += 1 + sovRpc(uint64(m.TotalCount))
	}
	if m.TotalSize != 0 {
		n += 1 + sovRpc(uint64(m.TotalSize))
	}
	return n
}
...
func (m *RequestOp_RequestRangeStream) Size() (n int) {
	var l int
	_ = l
	if m.RequestRangeStream != nil {
		l = m.RequestRangeStream.Size()
		n += 1 + l + sovRpc(uint64(l))
	}
	return n
}
...
func (m *ResponseOp_ResponseRangeStream) Size() (n int) {
	var l int
	_ = l
	if m.ResponseRangeStream != nil {
		l = m.ResponseRangeStream.Size()
		n += 1 + l + sovRpc(uint64(l))
	}
	return n
}
...
func (m *RangeStreamRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RangeStreamRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RangeStreamRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RequestOp) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequestRangeStream", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &RangeStreamRequest{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Request = &RequestOp_RequestRangeStream{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRpc(dAtA[iNdEx:])
...
func (m *ResponseOp) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResponseRangeStream", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &RangeStreamResponse{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Response = &ResponseOp_ResponseRangeStream{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRpc(dAtA[iNdEx:])
...
var fileDescriptorRpc = []byte{
	// 4231 bytes of a gzipped FileDescriptorProto
	,
}
