...
type InternalRaftRequest struct {
	...
	QosEnable                *QoSEnableRequest                         `protobuf:"bytes,1400,opt,name=qos_enable,json=qosEnable" json:"qos_enable,omitempty"`
	QosDisable               *QoSDisableRequest                        `protobuf:"bytes,1401,opt,name=qos_disable,json=qosDisable" json:"qos_disable,omitempty"`
	QosRuleAdd               *QoSRuleAddRequest                        `protobuf:"bytes,1402,opt,name=qos_rule_add,json=qosRuleAdd" json:"qos_rule_add,omitempty"`
	QosRuleUpdate            *QoSRuleUpdateRequest                     `protobuf:"bytes,1403,opt,name=qos_rule_update,json=qosRuleUpdate" json:"qos_rule_update,omitempty"`
	QosRuleDelete            *QoSRuleDeleteRequest                     `protobuf:"bytes,1404,opt,name=qos_rule_delete,json=qosRuleDelete" json:"qos_rule_delete,omitempty"`
	QosRuleGet               *QoSRuleGetRequest                        `protobuf:"bytes,1405,opt,name=qos_rule_get,json=qosRuleGet" json:"qos_rule_get,omitempty"`
	QosRuleList              *QoSRuleListRequest                       `protobuf:"bytes,1406,opt,name=qos_rule_list,json=qosRuleList" json:"qos_rule_list,omitempty"`
}
...
func (m *InternalRaftRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.QosEnable != nil {
		...
		dAtA[i] = 0x57
		i++
		i = encodeVarintRaftInternal(dAtA, i, uint64(m.QosEnable.Size()))
		n32, err := m.QosEnable.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
	...
	if m.QosDisable != nil {
		...
		dAtA[i] = 0x57
		i++
		i = encodeVarintRaftInternal(dAtA, i, uint64(m.QosDisable.Size()))
		n33, err := m.QosDisable.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n33
	...
	if m.QosRuleAdd != nil {
		...
		dAtA[i] = 0x57
		i++
		i = encodeVarintRaftInternal(dAtA, i, uint64(m.QosRuleAdd.Size()))
		n34, err := m.QosRuleAdd.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n34
	}
	if m.QosRuleUpdate != nil {
		dAtA[i] = 0xda
		i++
		dAtA[i] = 0x57
		i++
		i = encodeVarintRaftInternal(dAtA, i, uint64(m.QosRuleUpdate.Size()))
		n35, err := m.QosRuleUpdate.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
	}
	if m.QosRuleDelete != nil {
		dAtA[i] = 0xe2
		i++
		dAtA[i] = 0x57
		i++
		i = encodeVarintRaftInternal(dAtA, i, uint64(m.QosRuleDelete.Size()))
		n36, err := m.QosRuleDelete.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
	...
	if m.QosRuleGet != nil {
		...
		dAtA[i] = 0x57
		i++
		i = encodeVarintRaftInternal(dAtA, i, uint64(m.QosRuleGet.Size()))
		n37, err := m.QosRuleGet.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
	}
	if m.QosRuleList != nil {
		dAtA[i] = 0xf2
		i++
		dAtA[i] = 0x57
		i++
		i = encodeVarintRaftInternal(dAtA, i, uint64(m.QosRuleList.Size()))
		n38, err := m.QosRuleList.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n38
...
func (m *InternalRaftRequest) Size() (n int) {
	...
	if m.QosRuleUpdate != nil {
		l = m.QosRuleUpdate.Size()
		n += 2 + l + sovRaftInternal(uint64(l))
	}
	if m.QosRuleDelete != nil {
		l = m.QosRuleDelete.Size()
		n += 2 + l + sovRaftInternal(uint64(l))
	}
	if m.QosRuleGet != nil {
		l = m.QosRuleGet.Size()
...
func (m *InternalRaftRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1400:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QosEnable", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.QosEnable == nil {
				m.QosEnable = &QoSEnableRequest{}
			}
			if err := m.QosEnable.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 1401:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QosDisable", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.QosDisable == nil {
				m.QosDisable = &QoSDisableRequest{}
			}
			if err := m.QosDisable.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 1402:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QosRuleAdd", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.QosRuleAdd == nil {
				m.QosRuleAdd = &QoSRuleAddRequest{}
			}
			if err := m.QosRuleAdd.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 1403:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QosRuleUpdate", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.QosRuleUpdate == nil {
				m.QosRuleUpdate = &QoSRuleUpdateRequest{}
			}
			if err := m.QosRuleUpdate.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 1404:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QosRuleDelete", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.QosRuleDelete == nil {
				m.QosRuleDelete = &QoSRuleDeleteRequest{}
			}
			if err := m.QosRuleDelete.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 1405:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QosRuleGet", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.QosRuleGet == nil {
				m.QosRuleGet = &QoSRuleGetRequest{}
			}
			if err := m.QosRuleGet.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 1406:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QosRuleList", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.QosRuleList == nil {
				m.QosRuleList = &QoSRuleListRequest{}
			}
			if err := m.QosRuleList.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorRaftInternal = []byte{
	...
	,
}
