...
func recoverSnapshotBackend(cfg ServerConfig, oldbe backend.Backend, snapshot raftpb.Snapshot) (backend.Backend, error) {
	...
	kv := mvcc.New(cfg.Logger, oldbe, &lease.FakeLessor{}, &namespacequota.FakeNamespaceQuotaManager{}, nil, &cIndex, mvcc.StoreConfig{CompactionBatchLimit: cfg.CompactionBatchLimit})
	defer kv.Close()
