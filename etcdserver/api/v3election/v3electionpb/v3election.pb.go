...
func (*CampaignRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_v3election_ec133a72a9a21add, []int{0}
}
...
func (dst *CampaignRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CampaignRequest.Merge(dst, src)
}
...
func (*CampaignResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_v3election_ec133a72a9a21add, []int{1}
}
...
func (dst *CampaignResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CampaignResponse.Merge(dst, src)
}
...
func (*LeaderKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_v3election_ec133a72a9a21add, []int{2}
}
...
func (dst *LeaderKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LeaderKey.Merge(dst, src)
}
...
func (*LeaderRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_v3election_ec133a72a9a21add, []int{3}
}
...
func (dst *LeaderRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LeaderRequest.Merge(dst, src)
}
...
func (*LeaderResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_v3election_ec133a72a9a21add, []int{4}
}
...
func (dst *LeaderResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LeaderResponse.Merge(dst, src)
}
...
func (*ResignRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_v3election_ec133a72a9a21add, []int{5}
}
...
func (dst *ResignRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResignRequest.Merge(dst, src)
}
...
func (*ResignResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_v3election_ec133a72a9a21add, []int{6}
}
...
func (dst *ResignResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResignResponse.Merge(dst, src)
}
...
func (*ProclaimRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_v3election_ec133a72a9a21add, []int{7}
}
...
func (dst *ProclaimRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProclaimRequest.Merge(dst, src)
}
...
func (*ProclaimResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_v3election_ec133a72a9a21add, []int{8}
}
...
func (dst *ProclaimResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProclaimResponse.Merge(dst, src)
}
...
func init() { proto.RegisterFile("v3election.proto", fileDescriptor_v3election_ec133a72a9a21add) }

var fileDescriptor_v3election_ec133a72a9a21add = []byte{
