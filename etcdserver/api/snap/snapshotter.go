...
import (
	...
	"github.com/cyralinc/etcd/etcdserver/api/snap/snappb"
	pioutil "github.com/cyralinc/etcd/pkg/ioutil"
...
var (
	plog = capnslog.NewPackageLogger("github.com/cyralinc/etcd/v3", "snap")
