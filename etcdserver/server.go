...
import (
	...
	"go.etcd.io/etcd/v4/auth"
	"go.etcd.io/etcd/v4/etcdserver/api"
	"go.etcd.io/etcd/v4/etcdserver/api/membership"
	"go.etcd.io/etcd/v4/etcdserver/api/rafthttp"
	"go.etcd.io/etcd/v4/etcdserver/api/snap"
	"go.etcd.io/etcd/v4/etcdserver/api/v2discovery"
	"go.etcd.io/etcd/v4/etcdserver/api/v2http/httptypes"
	stats "go.etcd.io/etcd/v4/etcdserver/api/v2stats"
	"go.etcd.io/etcd/v4/etcdserver/api/v2store"
	"go.etcd.io/etcd/v4/etcdserver/api/v3alarm"
	"go.etcd.io/etcd/v4/etcdserver/api/v3compactor"
	pb "go.etcd.io/etcd/v4/etcdserver/etcdserverpb"
	"go.etcd.io/etcd/v4/lease"
	"go.etcd.io/etcd/v4/lease/leasehttp"
	"go.etcd.io/etcd/v4/mvcc"
	"go.etcd.io/etcd/v4/mvcc/backend"
	"go.etcd.io/etcd/v4/pkg/fileutil"
	"go.etcd.io/etcd/v4/pkg/idutil"
	"go.etcd.io/etcd/v4/pkg/pbutil"
	"go.etcd.io/etcd/v4/pkg/runtime"
	"go.etcd.io/etcd/v4/pkg/schedule"
	"go.etcd.io/etcd/v4/pkg/traceutil"
	"go.etcd.io/etcd/v4/pkg/types"
	"go.etcd.io/etcd/v4/pkg/wait"
	"go.etcd.io/etcd/v4/raft"
	"go.etcd.io/etcd/v4/raft/raftpb"
	"go.etcd.io/etcd/v4/version"
	"go.etcd.io/etcd/v4/wal"
...
var (
	plog = capnslog.NewPackageLogger("go.etcd.io/etcd/v4", "etcdserver")
