...
import (
	...
	"go.etcd.io/etcd/v4/clientv3/credentials"
	"go.etcd.io/etcd/v4/etcdserver"
	"go.etcd.io/etcd/v4/etcdserver/api/v3client"
	"go.etcd.io/etcd/v4/etcdserver/api/v3election"
	"go.etcd.io/etcd/v4/etcdserver/api/v3election/v3electionpb"
	v3electiongw "go.etcd.io/etcd/v4/etcdserver/api/v3election/v3electionpb/gw"
	"go.etcd.io/etcd/v4/etcdserver/api/v3lock"
	"go.etcd.io/etcd/v4/etcdserver/api/v3lock/v3lockpb"
	v3lockgw "go.etcd.io/etcd/v4/etcdserver/api/v3lock/v3lockpb/gw"
	"go.etcd.io/etcd/v4/etcdserver/api/v3rpc"
	etcdservergw "go.etcd.io/etcd/v4/etcdserver/etcdserverpb/gw"
	"go.etcd.io/etcd/v4/pkg/debugutil"
	"go.etcd.io/etcd/v4/pkg/httputil"
	"go.etcd.io/etcd/v4/pkg/transport"
