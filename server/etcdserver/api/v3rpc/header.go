...
//
// leader_id is the serving member's advisory leader view. It can be zero and
// is neither atomic with raft_term nor a guarantee that the leader remains leader.
