...
func (s *EtcdServer) Range(ctx context.Context, r *pb.RangeRequest) (*pb.RangeResponse, error) {
	...
	s.Logger().Info("Range: client request started", zap.Uint64("client-request-id", clientReqID))
	if !r.Serializable {
		...
		s.Logger().Info("Range: linearizable read confirmed", zap.Uint64("client-request-id", clientReqID), zap.Uint64("read-index", readIndex), zap.Uint64("read-index-id", readIndexID))
	}
...
func (s *EtcdServer) Put(ctx context.Context, r *pb.PutRequest) (*pb.PutResponse, error) {
	...
	s.Logger().Info("Put: client request completed", zap.Uint64("client-request-id", clientReqID), zap.Int64("revision", putResp.Header.Revision), zap.Uint64("proposed-index", resp.Index))
	return putResp, nil
}
...
func (s *EtcdServer) DeleteRange(ctx context.Context, r *pb.DeleteRangeRequest) (*pb.DeleteRangeResponse, error) {
	...
	s.Logger().Info("DeleteRange: client request completed", zap.Uint64("client-request-id", clientReqID), zap.Int64("revision", delResp.Header.Revision), zap.Uint64("proposed-index", resp.Index))
	return delResp, nil
}
...
func (s *EtcdServer) Txn(ctx context.Context, r *pb.TxnRequest) (*pb.TxnResponse, error) {
	...
	if readOnly {
		if !txn.IsTxnSerializable(r) {
			...
			s.Logger().Info("Txn: linearizable read confirmed", zap.Uint64("client-request-id", clientReqID), zap.Uint64("read-index", readIndex), zap.Uint64("read-index-id", readIndexID))
		}
	...
	s.Logger().Info("Txn: client request completed", zap.Uint64("client-request-id", clientReqID), zap.Int64("revision", txnResp.Header.Revision), zap.Uint64("proposed-index", resp.Index))
	return txnResp, nil
}
...
func (s *EtcdServer) Authenticate(ctx context.Context, r *pb.AuthenticateRequest) (*pb.AuthenticateResponse, error) {
	...
	s.Logger().Info("Authenticate: linearizable read confirmed", zap.Uint64("client-request-id", clientReqID), zap.Uint64("read-index", readIndex), zap.Uint64("read-index-id", readIndexID))
...
func (s *EtcdServer) linearizableReadLoop() {
	for {
		...
		s.Logger().Info("linearizableReadLoop: start request", zap.Uint64("read-index-id", requestID))
		...
		s.Logger().Info("linearizableReadLoop: confirmed request", zap.Uint64("read-index-id", requestID), zap.Uint64("confirmed-index", confirmedIndex), zap.Uint64("applied-index", s.getAppliedIndex()))
...
func (s *EtcdServer) requestCurrentIndex(leaderChangedNotifier <-chan struct{}, requestID uint64) (uint64, error) {
	...
	lg := s.Logger()
	lg.Info("requestCurrentIndex: sent ReadIndex request", zap.Uint64("read-index-id", requestID))
	...
	for {
		...
		case rs := <-s.r.readStateC:
			...
			lg.Info("requestCurrentIndex: received ReadIndex response", zap.Uint64("read-index-id", requestID), zap.Uint64("index", rs.Index))
			return rs.Index, nil
		case <-leaderChangedNotifier:
			readIndexFailed.Inc()
			lg.Warn("requestCurrentIndex: leader changed, retrying", zap.Uint64("read-index-id", requestID))
			// return a retryable error.
			return 0, errors.ErrLeaderChanged
		case <-firstCommitInTermNotifier:
			firstCommitInTermNotifier = s.firstCommitInTerm.Receive()
			lg.Info("first commit in current term: resending ReadIndex request", zap.Uint64("read-index-id", requestID))
			err := s.sendReadIndex(requestID)
			if err != nil {
				return 0, err
			}
		...
		case <-errorTimer.C:
			lg.Warn(
				...
				zap.Uint64("read-index-id", requestID),
			)
			slowReadIndex.Inc()
