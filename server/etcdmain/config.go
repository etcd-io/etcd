...
func newConfig() *config {
	...
	fs.BoolVar(&cfg.ec.PeerTLSInfo.EnableRootCAReload, "peer-client-root-ca-reload", false, "Enable peer client TLS root CA dynamic reload to support root CA rotation")
