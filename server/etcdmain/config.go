...
func newConfig() *config {
	...
	fs.BoolVar(&cfg.ec.ReuseAddress, "address-sharing", cfg.ec.ReuseAddress, "Enable to allow binding of multiple address and ports without waiting for kernel to release sockets.")
