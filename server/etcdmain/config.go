...
func newConfig() *config {
	...
	fs.BoolVar(&cfg.ec.ExperimentalReportKVDecodeError, "experimental-report-kv-decode-error", false, "Enable WatchableStore to report error instead of panic when decoding KVValue failed.")
