...
func newConfig() *config {
	...
	fs.BoolVar(&cfg.ec.ExperimentalEnableLeaseV2Renew, "experimental-enable-lease-v2-renew", true, "Enable lease v2 renew implementation. Will be deprecated in 3.7.")
	// TODO: delete in v3.7
