...
type Config struct {
	...
	// CustomClientTLSConfig and CustomPeerTLSConfig are especially useful when you want to
	// programmatically inject certificates instead of referencing file paths to certificates.
