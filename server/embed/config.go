...
type Config struct {
	...
	// SetMemberLocalAddr specifies if true, that etcd should use the host in
	// AdvertisePeerUrls as the LocalAddr when communicating with a peer.
...
func (cfg *Config) AddFlags(fs *flag.FlagSet) {
	...
	fs.BoolVar(&cfg.SetMemberLocalAddr, "set-member-localaddr", false, "Enable to have etcd use the host from initial-advertise-peer-urls as the local address when communicating with a peer.")
