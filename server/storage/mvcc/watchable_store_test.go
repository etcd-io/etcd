...
func TestWatch(t *testing.T) {
	...
	s := newWatchableStore(zaptest.NewLogger(t), b, &lease.FakeLessor{}, &namespacequota.FakeNamespaceQuotaManager{}, StoreConfig{})
...
func TestCancelUnsynced(t *testing.T) {
	...
	s := &watchableStore{
		store:    NewStore(zaptest.NewLogger(t), b, &lease.FakeLessor{}, &namespacequota.FakeNamespaceQuotaManager{}, StoreConfig{}),
...
func TestWatchRestore(t *testing.T) {
	test := func(delay time.Duration) func(t *testing.T) {
		return func(t *testing.T) {
			...
			newStore := newWatchableStore(zaptest.NewLogger(t), newBackend, &lease.FakeLessor{}, &namespacequota.FakeNamespaceQuotaManager{}, StoreConfig{})
...
func TestWatchRestoreSyncedWatcher(t *testing.T) {
	...
	s1 := newWatchableStore(zaptest.NewLogger(t), b1, &lease.FakeLessor{}, &namespacequota.FakeNamespaceQuotaManager{}, StoreConfig{})
	defer cleanup(s1, b1, b1Path)

	b2, b2Path := betesting.NewDefaultTmpBackend(t)
	s2 := newWatchableStore(zaptest.NewLogger(t), b2, &lease.FakeLessor{}, &namespacequota.FakeNamespaceQuotaManager{}, StoreConfig{})
