...
func validateWatch(t *testing.T, cfg Config, reports []model.ClientReport) []model.WatchEvent {
...
func validateBookmarkable(t *testing.T, report model.ClientReport) {
...
func validateOrdered(t *testing.T, report model.ClientReport) {
...
func validateUnique(t *testing.T, expectUniqueRevision bool, report model.ClientReport) {
...
func validateAtomic(t *testing.T, report model.ClientReport) {
	var lastEventRevision int64 = 1
	for _, op := range report.Watch {
		for _, resp := range op.Responses {
...
func validateReliable(t *testing.T, events []model.WatchEvent, report model.ClientReport) {
	for _, op := range report.Watch {
		index := 0
...
func validateResumable(t *testing.T, events []model.WatchEvent, report model.ClientReport) {
	for _, op := range report.Watch {
		index := 0
...
func mergeWatchEventHistory(t *testing.T, reports []model.ClientReport) []model.WatchEvent {
