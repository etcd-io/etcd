...
gofail-enable: install-gofail
	gofail enable server/etcdserver/ server/etcdserver/api/rafthttp/ server/storage/backend/ server/storage/mvcc/ server/storage/wal/
...
gofail-disable: install-gofail
	gofail disable server/etcdserver/ server/etcdserver/api/rafthttp/ server/storage/backend/ server/storage/mvcc/ server/storage/wal/
