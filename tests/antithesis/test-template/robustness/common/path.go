...
func DefaultPaths(cfg *config.Config) (hosts []string, reportPath string, dataPaths map[string]string) {
...
func LocalPaths(cfg *config.Config) (hosts []string, reportPath string, dataPaths map[string]string) {
