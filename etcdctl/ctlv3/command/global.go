...
func mustClient(endpoints []string, dialTimeout time.Duration, scfg *secureCfg, compressType compress.Type) *clientv3.Client {
	cfg, err := newClientCfg(endpoints, dialTimeout, scfg, compressType)
	if err != nil {
