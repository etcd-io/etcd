...
const (
	// ----- content types ----
	codecSelferCcUTF87467 = 1
	codecSelferCcRAW7467  = 0
	// ----- value types used ----
	codecSelferValueTypeArray7467  = 10
	codecSelferValueTypeMap7467    = 9
	codecSelferValueTypeString7467 = 6
	codecSelferValueTypeInt7467    = 2
	codecSelferValueTypeUint7467   = 3
	codecSelferValueTypeFloat7467  = 4
	codecSelferBitsize7467         = uint8(32 << (^uint(0) >> 63))
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct7467 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer7467 struct{}
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `errorCode`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeInt(int64(x.Code))
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF87467, string(x.Message))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `message`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF87467, string(x.Message))
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF87467, string(x.Cause))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `cause`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF87467, string(x.Cause))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `index`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.Index))
...
func (x *Error) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if false {
		...
		if yyct2 == codecSelferValueTypeMap7467 {
			yyl2 := r.ReadMapStart()
			if yyl2 == 0 {
				r.ReadMapEnd()
			} else {
		...
		} else if yyct2 == codecSelferValueTypeArray7467 {
			...
			panic(errCodecSelferOnlyMapOrArrayEncodeToStruct7467)
		}
	}
}
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "errorCode":
			if r.TryDecodeAsNil() {
				...
				x.Code = (int)(z.C.IntV(r.DecodeInt64(), codecSelferBitsize7467))
			}
		case "message":
			if r.TryDecodeAsNil() {
				x.Message = ""
...
func (x PrevExistType) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if false {
		...
		r.EncodeString(codecSelferCcUTF87467, string(x))
	}
}
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `AfterIndex`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.AfterIndex))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `Recursive`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.Recursive))
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `TTL`)
				r.WriteMapElemValue()
				if false {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF87467, string(x.PrevValue))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `PrevValue`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF87467, string(x.PrevValue))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `PrevIndex`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.PrevIndex))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `PrevExist`)
				r.WriteMapElemValue()
				x.PrevExist.CodecEncodeSelf(e)
			}
			if yyr2 || yy2arr2 {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `Refresh`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.Refresh))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `Dir`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.Dir))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `NoValueOnSuccess`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.NoValueOnSuccess))
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `Quorum`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.Quorum))
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF87467, string(x.Action))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `action`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF87467, string(x.Action))
		...
		LABEL6:
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `node`)
				r.WriteMapElemValue()
				if yyn6 {
					r.EncodeNil()
				} else {
		...
		LABEL9:
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `prevNode`)
				r.WriteMapElemValue()
				if yyn9 {
					r.EncodeNil()
				} else {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF87467, string(x.Key))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `key`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF87467, string(x.Key))
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF87467, string(x.Value))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `value`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF87467, string(x.Value))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `nodes`)
				r.WriteMapElemValue()
				if x.Nodes == nil {
					r.EncodeNil()
				} else {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `modifiedIndex`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.ModifiedIndex))
		...
		LABEL21:
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					r.WriteMapElemKey()
					r.EncodeString(codecSelferCcUTF87467, `expiration`)
					r.WriteMapElemValue()
					if yyn21 {
						r.EncodeNil()
					} else {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF87467, string(x.Prefix))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `Prefix`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF87467, string(x.Prefix))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `Sorted`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.Sorted))
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `WaitIndex`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.WaitIndex))
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF87467, string(x.Dir))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF87467, `Dir`)
...
func (x codecSelfer7467) encNodes(v Nodes, e *codec1978.Encoder) {
	var h codecSelfer7467
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
...
func (x codecSelfer7467) decNodes(v *Nodes, d *codec1978.Decoder) {
	var h codecSelfer7467
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
