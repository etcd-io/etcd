...
const (
	// ----- content types ----
	codecSelferCcUTF88411 = 1
	codecSelferCcRAW8411  = 0
	// ----- value types used ----
	codecSelferValueTypeArray8411  = 10
	codecSelferValueTypeMap8411    = 9
	codecSelferValueTypeString8411 = 6
	codecSelferValueTypeInt8411    = 2
	codecSelferValueTypeUint8411   = 3
	codecSelferValueTypeFloat8411  = 4
	codecSelferBitsize8411         = uint8(32 << (^uint(0) >> 63))
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct8411 = errors.New(`only encoded map or array can be decoded into a struct`)
)
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `errorCode`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeInt(int64(x.Code))
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF88411, string(x.Message))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `message`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF88411, string(x.Message))
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF88411, string(x.Cause))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `cause`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF88411, string(x.Cause))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `index`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.Index))
...
func (x *Error) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if false {
		...
		if yyct2 == codecSelferValueTypeMap8411 {
			yyl2 := r.ReadMapStart()
			if yyl2 == 0 {
				r.ReadMapEnd()
			} else {
		...
		} else if yyct2 == codecSelferValueTypeArray8411 {
			...
			panic(errCodecSelferOnlyMapOrArrayEncodeToStruct8411)
		}
	}
}
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "errorCode":
			if r.TryDecodeAsNil() {
				...
				x.Code = (int)(z.C.IntV(r.DecodeInt64(), codecSelferBitsize8411))
			}
		case "message":
			if r.TryDecodeAsNil() {
				x.Message = ""
...
func (x PrevExistType) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if false {
		...
		r.EncodeString(codecSelferCcUTF88411, string(x))
	}
}
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `AfterIndex`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.AfterIndex))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `Recursive`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.Recursive))
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `TTL`)
				r.WriteMapElemValue()
				if false {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF88411, string(x.PrevValue))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `PrevValue`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF88411, string(x.PrevValue))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `PrevIndex`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.PrevIndex))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `PrevExist`)
				r.WriteMapElemValue()
				x.PrevExist.CodecEncodeSelf(e)
			}
			if yyr2 || yy2arr2 {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `Refresh`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.Refresh))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `Dir`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.Dir))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `NoValueOnSuccess`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.NoValueOnSuccess))
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `Sort`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.Sort))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `Quorum`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.Quorum))
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF88411, string(x.Action))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `action`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF88411, string(x.Action))
		...
		LABEL9:
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `prevNode`)
				r.WriteMapElemValue()
				if yyn9 {
					r.EncodeNil()
				} else {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF88411, string(x.Key))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `key`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF88411, string(x.Key))
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF88411, string(x.Value))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `value`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF88411, string(x.Value))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `nodes`)
				r.WriteMapElemValue()
				if x.Nodes == nil {
					r.EncodeNil()
				} else {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `createdIndex`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.CreatedIndex))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `modifiedIndex`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.ModifiedIndex))
		...
		LABEL21:
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					r.WriteMapElemKey()
					r.EncodeString(codecSelferCcUTF88411, `expiration`)
					r.WriteMapElemValue()
					if yyn21 {
						r.EncodeNil()
					} else {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF88411, string(x.Prefix))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `Prefix`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF88411, string(x.Prefix))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `Sorted`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeBool(bool(x.Sorted))
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `WaitIndex`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.WaitIndex))
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF88411, string(x.Dir))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF88411, `Dir`)
...
func (x codecSelfer8411) encNodes(v Nodes, e *codec1978.Encoder) {
	var h codecSelfer8411
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
...
func (x codecSelfer8411) decNodes(v *Nodes, d *codec1978.Decoder) {
	var h codecSelfer8411
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
