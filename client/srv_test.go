...
func TestSRVDiscover(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			[]string{"http://a.example.com:2480", "http://b.example.com:2480", "http://c.example.com:2480"},
		},
		{
			[]*net.SRV{
				{Target: "a.example.com.", Port: 2480},
			...
			[]string{"https://a.example.com:2480", "https://b.example.com:2480", "https://c.example.com:2480", "http://a.example.com:2480"},
		},
	}
